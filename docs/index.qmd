...
format:
  revealjs:
    ...
    footer: "link.njtierney.com/botb26-talk"
execute:
  echo: true
  warning: false
  cache: true
...
::::: columns
::: {.column width="45%"}
> Use [mgcv](https://CRAN.R-project.org/package=mgcv) smoother functions and formula syntax to define smooth terms for use in a [greta](https://greta-stats.org/) model. Define your likelihood, fit with MCMC.
:::
...
-   HMC Snaper (Sountsov & Hoffman)
-   Extension packages (lme-like formula, more distributions, point processes)
-   Upgrading to latest TF methods
-   Improved "auto" installation
-   "Swappable" backends (`use_touch()/base()/tf()`, etc.)
-   Further customisation to GPU
...
## Our turn: posit.cloud `link.njtierney.com/botb26-workshop` {.small}
...
#| fig-width: 7
#| fig-height: 7
cloud_link <- qrcode::qr_code("link.njtierney.com/botb26-workshop")
plot(cloud_link)
```
:::
...
-   [greta-dev/greta-botb26-workshop](https://github.com/greta-dev/greta-botb26-workshop)
:::
::::
::::::
...
-   **Help:** <https://forum.greta-stats.org/>

Install via github or [r-universe](https://greta-dev.r-universe.dev/builds) (Soon to be **back on CRAN**)
